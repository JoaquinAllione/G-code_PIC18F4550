...
void DirectionSet(motor *M, direction_enum dir){
    switch((*M).axis_commanded.designator){
        case AXIS_X:
            LATCbits.LATC0 = dir;
            break;
        case AXIS_Y:
...
void MicroStepSet(motor *M, MicroStep_enum MS){
    ...
    LATDbits.LATD3 = 0; LATDbits.LATD4 = 0; LATDbits.LATD5 = 0;
    ...
    switch(MS){
        case FULL_STEP:
            ...
            break;
        case HALF_STEP:
            (*M).steps_per_mm = 2*100;
            LATDbits.LATD3 = 1;
            break;
        case QUATER_STEP:
            (*M).steps_per_mm = 4*100;
            LATDbits.LATD4 = 1;
            break;
        case EIGHTH_STEP:
            (*M).steps_per_mm = 8*100;
            LATDbits.LATD3 = 1; LATDbits.LATD4 = 1;
            break;
        case SIXTEENTH_STEP:
            (*M).steps_per_mm = 16*100;
            LATDbits.LATD3 = 1; LATDbits.LATD4 = 1; LATDbits.LATD5 = 1;
            break;
    }
...
void Motors_Init(void){
    ...
    MicroStepSet(&motor_1, FULL_STEP);
...
void PrintMotorDirConfig(motor *M){
    ...
    if ((*M).dir == CLOCKWISE){
        putUSBUSART(((const __attribute__((space(prog))) char *)("Direction: CLOCKWISE\n")),sizeof("Direction: CLOCKWISE\n"));
    }else{
    ...
    while((token != ((void*)0))&&(!invalid_command)) {
        ...
        switch(letter){
            ...
            case 'G':
                ...
                interger = truncf(strtof(token, &endPtr));
                switch(interger) {
                    case 0:
                    ...
                    case 92:
                        ...
                        break;
                    default:
                        putUSBUSART(((const __attribute__((space(prog))) char *)("Unsupported Command.\n")),sizeof("Unsupported Command.\n"));
                        invalid_command = 1;
                        command = -1;
                        break;
