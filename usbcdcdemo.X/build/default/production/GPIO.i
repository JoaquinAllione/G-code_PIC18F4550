...
void MicroStepConfig_Get(MicroStep_enum MS){
    switch(MS){
        case Full_Step:
...
MicroStep_enum MicroStepConfig_Set(MicroStep_enum MS){
...
void Enable_Axes(Axes_enum axis){
    switch(axis){
        case Axis_X:
            ((LATD) &= ~(1<<(0)));
            break;
...
void Disable_Axes(Axes_enum axis){
    switch(axis){
        case Axis_X:
            ((LATD) |= (1<<(0)));
            break;
